function [canvas] = cellrecog( boundaries, Nrgb)
...
maxDx = 0;
maxDy = 0;
Dxlist = zeros(1,holenum(1));
Dylist = zeros(1,holenum(1));
for k = 1:holenum(1)
    b = boundaries{k,1};
...
disp('Normal Cell Number:');disp(normal);
disp('Abnormal Cell Number:');disp(sick);
end